...
class TorX509TrustManager implements X509TrustManager {
    ...
    static Pattern cnPattern = Pattern.compile("CN=(.*?)[,.*]", Pattern.UNIX_LINES + Pattern.CASE_INSENSITIVE + Pattern.DOTALL);
...
//        if (chain.length != 2) {
//            throw new CertificateException("Certificate Chain dataLength != 2");
//        }
//
...
//            LogFactory.getLog(getClass()).warn("TorX509TrustManager.checkServerTrusted(): not matched");
...
//        LogFactory.getLog(getClass()).trace("dnName0 = " + dnName0.toString() + ", dnName1 = " + dnName1.toString());
...
//        // stuff of the Directory entry and compared to the one given here.
    ...
    public X509Certificate[] getAcceptedIssuers() {
        LogFactory.getLog(getClass()).debug("X509Certificate[] getAcceptedIssuers()");
