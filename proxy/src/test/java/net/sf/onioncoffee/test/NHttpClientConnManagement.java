...
/**
 * Example of a very simple asynchronous connection manager that maintains a
 * pool of persistent connections to one target host.
 * <p>
...
public class NHttpClientConnManagement {
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 5000).setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 10000).setIntParameter(CoreConnectionPNames.SOCKET_BUFFER_SIZE, 8 * 1024).setBooleanParameter(CoreConnectionPNames.STALE_CONNECTION_CHECK, false)
                .setBooleanParameter(CoreConnectionPNames.TCP_NODELAY, true).setParameter(CoreProtocolPNames.USER_AGENT, "HttpComponents/1.1");
        ...
        BufferingHttpClientHandler protocolHandler = new BufferingHttpClientHandler(httpproc, new MyHttpRequestExecutionHandler(), new DefaultConnectionReuseStrategy(), params);
        ...
        // Use the connection manager to maintain a pool of connections to
        // localhost:8080
        final AsyncConnectionManager connMgr = new AsyncConnectionManager(new HttpHost("localhost", 8080), maxTotalConnections, protocolHandler, params);
    ...
    static class AsyncConnectionManager {
        ...
        public void execute() throws IOException {
            IOEventDispatch dispatch = new DefaultClientIOEventDispatch(new ManagedClientHandler(this.handler, this), this.params);
